    ...
    return (
        <group position={position} layers={ROBOT_LAYER} userData={{ isRobotPart: true }}>
            ...
            <group ref={groupRef} layers={ROBOT_LAYER} userData={{ isRobotPart: true }}>
                <mesh position={[0, 0, 0]} castShadow layers={ROBOT_LAYER} userData={{ isRobotPart: true }}><cylinderGeometry args={[0.08, 0.08, 1, 16]} /><meshStandardMaterial color={THEME.lightGrey} /></mesh>
